...
<head>
    ...
    <link rel="stylesheet" href="treatmentStyles.css">
            ...
            <div class="row g-0">
              ...
              <div class="col-xl-12">
                <div class="card-body p-md-5 text-black">
                  <h3 class="mb-5 text-uppercase">Treatment Details</h3>

                  <div class="col-md-6 mb-4">
                    <div class="form-outline">
                      <input type="text" id="PatientIDtxt" class="form-control form-control-sm" />
                      <label class="form-label" for="PatientIDtxt">Treatment ID</label>
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 mb-4">
                      <div class="form-outline">
                        ...
                        <label class="form-label" for="ContactNumber(home)txt">Patient ID</label>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-6 mb-4">
                      <div class="form-outline">
                        <input type="text" id="ContactNumber(private)txt" class="form-control form-control-sm" />
                        <label class="form-label" for="ContactNumber(private)txt">Staff ID </label>
                      </div>
                    </div>
                    <div class="col-md-6 mb-4">
                      <div class="form-outline">
                        <input type="text" id="ContactNumber(home)txt" class="form-control form-control-sm" />
                        <label class="form-label" for="ContactNumber(home)txt">Room Number</label>
                      </div>
                    </div>
                  </div>
              ...
              <div class="row">
                  ...
                  <div class="col-md-6 mb-4">
                      <div class="form-outline">
                        <input type="text" id="ContactNumber(home)txt" class="form-control form-control-sm" />
                        <label class="form-label" for="ContactNumber(home)txt">Discharge or Not</label>
                      </div>
                    </div>
                  ...
                  <div class="d-flex justify-content-end pt-3">
                    ...
                    <button type="button" class="btn btn-primary btn-md ms-2">Update</button>
                  </div>
