...
<head>
    ...
    <link rel="stylesheet" href="css/operatingTheoterStyles.css">
            ...
            <div class="row g-0">
              ...
              <div class="col-xl-12">
                <div class="card-body p-md-5 text-black">
                  <h3 class="mb-5 text-uppercase">operating theoter</h3>

                  <div class="col-md-6 mb-4">
                    <div class="form-outline">
                      <input type="text" id="PatientIDtxt" class="form-control form-control-sm" />
                      <label class="form-label" for="PatientIDtxt">Operating Theoter Number</label>
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 mb-4">
                      <div class="form-outline">
                        ...
                        <label class="form-label" for="ContactNumber(home)txt">Time</label>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6 mb-4">
                      <div class="form-outline">
                        <input type="text" id="ContactNumber(home)txt" class="form-control form-control-sm" />
                        <label class="form-label" for="ContactNumber(home)txt">Available or Not</label>
                      </div>
                    </div>
