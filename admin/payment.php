            ...
            <div class="row g-0">
              ...
              <div class="col-xl-12">
                <div class="card-body p-md-5 text-black">
                  <h3 class="mb-5 text-uppercase">Invoice</h3>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 mb-4">
                      <div class="form-outline">
                        ...
                        <label class="form-label" for="ContactNumber(home)txt">Staff_ID</label>
                      </div>
                    </div>
                  </div>
                ...
                <label class="form-label" for="textAreaExample">Medical Items</label>
              </div>
                    </div>
                    <div class="col-md-6 mb-4">
                      <div class="form-outline">
                        <input type="text" id="ContactNumber(home)txt" class="form-control form-control-sm" />
                        <label class="form-label" for="ContactNumber(home)txt">Cost</label>
                      </div>
                    </div>
                  </div>
